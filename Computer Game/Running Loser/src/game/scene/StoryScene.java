...
public class StoryScene extends Scene{
    ...
    public void sceneBegin() {
        ...
        mode300 = new Button(WINDOW_WIDTH/2 - 700, WINDOW_HEIGHT/2 +250, Theme.get(4));
        ...
        mode600 = new Button(WINDOW_WIDTH/2 - 350, WINDOW_HEIGHT/2 +250, Theme.get(5));
        ...
        modeGoal = new Button(WINDOW_WIDTH/2, WINDOW_HEIGHT/2 +250, Theme.get(6));
        modeGoal.setClickedActionPerformed((int x, int y) -> {
            AudioResourceController.getInstance().shot(new Path().sound().button());//按鈕
            SceneController.instance().change(new PlayScene(Mode.GOAL));
        });
        home = new Button(WINDOW_WIDTH/2 + 350, WINDOW_HEIGHT/2 +250, Theme.get(3));
    ...
    public void paint(Graphics g) {
        ...
        g.drawImage(story, 220, 50, 1300, 900, null);
        mode300.paint(g);
        mode600.paint(g);
        modeGoal.paint(g);
        home.paint(g);
