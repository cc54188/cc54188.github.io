...
export class InterBank2Component extends BaseComponent<InterBankModel> implements OnInit {
    ...
    resetFormControl(): void {  // 剛進來disable(不檢查)
    ...
    updateAgentInfo(event: any){
        ...
        console.log('刷新代理人: ', value);

        console.log('代理人', this.myFormGroup);
    ...
    goNext(): void {
        console.log('第二夜FG: ', this.myFormGroup.getRawValue());
    ...
    add(data ?: InterBankModel){  // 類別改成這樣
